...
# --- Single input for movie ---
search_query = st.text_input("Search and select a movie:")

filtered_movies = movies[movies['title'].str.contains(search_query, case=False, na=False)] if search_query else pd.DataFrame()
...
# --- Display previous inputs with ratings ---
